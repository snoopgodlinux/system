...
- [libnotify-bin](https://packages.ubuntu.com/jammy/libnotify-bin)
...
- [python3-nmap](https://packages.ubuntu.com/jammy/python3-nmap)
...
- [qt6-base-dev](https://packages.ubuntu.com/jammy/qt6-base-dev)
...
- [perl-tk](https://packages.ubuntu.com/jammy/perl-tk)
...
- [abootimg](https://packages.ubuntu.com/jammy/abootimg)
- [android-sdk](https://packages.ubuntu.com/jammy/android-sdk)
...
- [cabextract](https://packages.ubuntu.com/jammy/cabextract)
- [cherrytree](https://packages.ubuntu.com/jammy/cherrytree)
- [chirp](https://packages.ubuntu.com/jammy/chirp)
- [cmake](https://packages.ubuntu.com/jammy/cmake)
- [curl](https://packages.ubuntu.com/jammy/curl)
- [cutycapt](https://packages.ubuntu.com/jammy/cutycapt)
...
- [fwbuilder](https://packages.ubuntu.com/jammy/fwbuilder)
...
- [gr-air-modes](https://packages.ubuntu.com/jammy/gr-air-modes)
- [gr-iqbal](https://packages.ubuntu.com/jammy/gr-iqbal)
- [gr-osmosdr](https://packages.ubuntu.com/jammy/gr-osmosdr)
- [gss-ntlmssp](https://packages.ubuntu.com/jammy/gss-ntlmssp)
- [hackrf](https://packages.ubuntu.com/jammy/hackrf)
- [hexedit](https://packages.ubuntu.com/jammy/hexedit)
- [htop](https://packages.ubuntu.com/jammy/htop)
- [httrack](https://packages.ubuntu.com/jammy/httrack)
- [inspectrum](https://packages.ubuntu.com/jammy/inspectrum)
- [jq](https://packages.ubuntu.com/jammy/jq)
- [kate](https://packages.ubuntu.com/jammy/kate)
- [kde-spectacle](https://packages.ubuntu.com/jammy/kde-spectacle)
...
- [postfix](https://packages.ubuntu.com/jammy/postfix)
- [proxychains](https://packages.ubuntu.com/jammy/proxychains)
- [qemu](https://packages.ubuntu.com/jammy/qemu)
- [rake](https://packages.ubuntu.com/jammy/rake)
- [rename](https://packages.ubuntu.com/jammy/rename)
- [reprepro](https://packages.ubuntu.com/jammy/reprepro)
- [rhythmbox](https://packages.ubuntu.com/jammy/rhythmbox)
...
- [bruteforce-luks](https://packages.ubuntu.com/jammy/bruteforce-luks)
- [bruteforce-salted-openssl](https://packages.ubuntu.com/jammy/bruteforce-salted-openssl)
- [bruteforce-wallet](https://packages.ubuntu.com/jammy/bruteforce-wallet)
- [brutespray](https://packages.ubuntu.com/jammy/brutespray)
- [ccrypt](https://packages.ubuntu.com/jammy/ccrypt)
- [cewl](https://packages.ubuntu.com/jammy/cewl)
- [changeme](https://packages.ubuntu.com/jammy/changeme)
- [cmospwd](https://packages.ubuntu.com/jammy/cmospwd)
- [crack](https://packages.ubuntu.com/jammy/crack)
- [crowbar](https://github.com/galkan/crowbar)
- [crunch](https://packages.ubuntu.com/jammy/crunch)
- [fcrackzip](https://packages.ubuntu.com/jammy/fcrackzip)
- [gpp-decrypt](https://blog.carnal0wnage.com/2012/10/group-policy-preferences-and-getting.html)
- [gtkhash](https://packages.ubuntu.com/jammy/gtkhash)
- [hashcat](https://packages.ubuntu.com/jammy/hashcat)
- [hashdeep](https://packages.ubuntu.com/jammy/hashdeep)
- [hashid](https://packages.ubuntu.com/jammy/hashid)
- [hashrat](https://packages.ubuntu.com/jammy/hashrat)
...
- [nasty](https://packages.ubuntu.com/jammy/nasty)
...
- [princeprocessor](https://packages.ubuntu.com/jammy/princeprocessor)
- [rainbowcrack](http://project-rainbowcrack.com/)
- [rsmangler](https://github.com/digininja/RSMangler)
- [sucrack](https://packages.ubuntu.com/jammy/sucrack)
...
- [weevely](https://packages.ubuntu.com/jammy/weevely)
...
- [dcfldd](https://packages.ubuntu.com/jammy/dcfldd)
- [ddrescue](http://www.garloff.de/kurt/linux/ddrescue/)
- [de4dot](https://packages.ubuntu.com/jammy/de4dot)
- [dislocker](https://packages.ubuntu.com/jammy/dislocker)
- [dumpzilla](https://www.dumpzilla.org/)
- [ext3grep](https://packages.ubuntu.com/jammy/ext3grep)
- [ext4magic](https://packages.ubuntu.com/jammy/ext4magic)
- [extundelete](https://packages.ubuntu.com/jammy/extundelete)
- [fatcat](https://packages.ubuntu.com/jammy/fatcat)
- [flashrom](https://packages.ubuntu.com/jammy/flashrom)
...
- [mac-robber](https://packages.ubuntu.com/jammy/mac-robber)
- [magicrescue](https://packages.ubuntu.com/jammy/magicrescue)
- [myrescue](https://packages.ubuntu.com/jammy/myrescue)
- [openocd](https://packages.ubuntu.com/jammy/openocd)
- [o-saft](https://packages.ubuntu.com/jammy/o-saft)
- [outguess](https://packages.ubuntu.com/jammy/outguess)
- [p0f](https://packages.ubuntu.com/jammy/p0f)
- [parted](https://packages.ubuntu.com/jammy/parted)
- [pasco](https://packages.ubuntu.com/jammy/pasco)
- [pdfcrack](https://packages.ubuntu.com/jammy/pdfcrack)
- [pdfid](https://blog.didierstevens.com/programs/pdf-tools/)
- [pdf-parser](https://blog.didierstevens.com/programs/pdf-tools/)
- [xmount](https://packages.ubuntu.com/jammy/xmount)
...
- [metacam](https://packages.ubuntu.com/jammy/metacam)
- [missidentify](https://packages.ubuntu.com/jammy/missidentify)
- [nikto](https://packages.ubuntu.com/jammy/nikto)
- [nmap](https://packages.ubuntu.com/jammy/nmap)
- [nmapsi4](https://packages.ubuntu.com/jammy/nmapsi4)
...
- [arpwatch](https://packages.ubuntu.com/jammy/arpwatch)
- [axel](https://packages.ubuntu.com/jammy/axel)
- [cntlm](https://packages.ubuntu.com/jammy/cntlm)
- [cryptcat](https://packages.ubuntu.com/jammy/cryptcat)
- [cymothoa](http://cymothoa.sourceforge.net/)
- [darkstat](https://packages.ubuntu.com/jammy/darkstat)
- [dns2tcp](https://packages.ubuntu.com/jammy/dns2tcp)
- [dnstwist](https://packages.ubuntu.com/jammy/dnstwist)
- [dsniff](https://packages.ubuntu.com/jammy/dsniff)
- [ethtool](https://packages.ubuntu.com/jammy/ethtool)
- [firewalk](https://packages.ubuntu.com/jammy/firewalk)
- [ifenslave](https://packages.ubuntu.com/jammy/ifenslave)
- [inetsim](https://packages.ubuntu.com/jammy/inetsim)
- [miredo](https://packages.ubuntu.com/jammy/miredo)
- [nbtscan](https://packages.ubuntu.com/jammy/nbtscan)
- [netcat](https://packages.ubuntu.com/jammy/netcat)
- [netdiscover](https://packages.ubuntu.com/jammy/netdiscover)
- [netmask](https://packages.ubuntu.com/jammy/netmask)
- [netsed](https://packages.ubuntu.com/jammy/netsed)
- [nishang](https://github.com/samratashok/nishang)
- [onesixtyone](https://packages.ubuntu.com/jammy/onesixtyone)
- [pnscan](https://packages.ubuntu.com/jammy/pnscan)
- [powersploit](https://github.com/PowerShellMafia/PowerSploit)
- [proxytunnel](https://packages.ubuntu.com/jammy/proxytunnel)
...
- [bettercap](https://packages.ubuntu.com/jammy/bettercap)
- [chaosreader](https://packages.ubuntu.com/jammy/chaosreader)
...
- [arping](https://packages.ubuntu.com/jammy/arping)
- [dhcpig](https://packages.ubuntu.com/jammy/dhcpig)
- [fping](https://packages.ubuntu.com/jammy/fping)
- [goldeneye](https://packages.ubuntu.com/jammy/goldeneye)
...
- [dirsearch](https://packages.ubuntu.com/jammy/dirsearch)
- [doona](https://packages.ubuntu.com/jammy/doona)
- [jsql-injection](https://github.com/ron190/jsql-injection)
- [pocsuite3](https://packages.ubuntu.com/jammy/pocsuite3)
- [pompem](https://packages.ubuntu.com/jammy/pompem)
...
- [wapiti](https://packages.ubuntu.com/jammy/wapiti)
...
- [bully](https://packages.ubuntu.com/jammy/bully)
- [cowpatty](https://packages.ubuntu.com/jammy/cowpatty)
- [fluxion](https://github.com/FluxionNetwork/fluxion)
- [iw](https://packages.ubuntu.com/jammy/iw)
- [mdk3](https://packages.ubuntu.com/jammy/mdk3)
- [mdk4](https://packages.ubuntu.com/jammy/mdk4)
