...
Pane {
    ...
    palette.button: config.BackgroundColor
    palette.highlight: config.AccentColor
    palette.text: config.MainColor
    palette.buttonText: config.MainColor
    palette.window: "#3a3a3a"
    ...
    Item {
        ...
        Rectangle {
            ...
            color: "#404048"
            opacity: config.PartialBlur == "true" ? 0.94 : 1
            z: 1
        }
        ...
        Image {
            ...
            fillMode: config.ScaleMethod === "PreserveAspectCrop" ? Image.PreserveAspectCrop :
                      config.ScaleMethod === "PreserveAspectFit" ? Image.PreserveAspectFit :
                      config.ScaleMethod === "Stretch" ? Image.Stretch : Image.PreserveAspectFit
            asynchronous: true
            cache: true
            clip: true
            mipmap: true
